...
namespace SkladchikGet.ServerApi.Utils
{
	...
	public static class VkResponseEx
    {
        ...
        /// <returns>Коллекция данных.</returns>
        public static Collection<T> ToCollectionOf<T>(this ApiResponse response, Func<ApiResponse, T> selector) //where T : class
        {
            if (response == null)
            {
        ...
        /// <param name="selector">Функция выборки.</param>
        /// <returns>Коллекция данных.</returns>
        public static Collection<T> ToCollectionOf<T>(this IEnumerable<ApiResponse> responses, Func<ApiResponse, T> selector)
        {
            if (responses == null)
            {
                return new Collection<T>(new List<T>());
        ...
        public static ReadOnlyCollection<T> ToReadOnlyCollectionOf<T>(
            this ApiResponse response, Func<ApiResponse, T> selector) where T : class
        {
            if (response == null)
            {
        ...
        /// <param name="selector">Функция выборки.</param>
        /// <returns>Коллекция данных только для чтения.</returns>
        public static ReadOnlyCollection<T> ToReadOnlyCollectionOf<T>(this IEnumerable<ApiResponse> responses, Func<ApiResponse, T> selector)
        {
            if (responses == null)
            {
                return new ReadOnlyCollection<T>(new List<T>());
        ...
        /// Список данных.
        /// </returns>
        public static List<T> ToListOf<T>(this ApiResponse response, Func<ApiResponse, T> selector)
        {
            if (response == null)
            {
                return new List<T>();
        ...
        /// Список данных.
        /// </returns>
        public static List<T> ToListOf<T>(this IEnumerable<ApiResponse> responses, Func<ApiResponse, T> selector)
        {
            if (responses == null)
            {
                return new List<T>();
        ...
        public static VkCollection<T> ToVkCollectionOf<T>(this ApiResponse response, Func<ApiResponse, T> selector)
        {
            if (response == null)
            {
            ...
            ApiResponseArray data = response.ContainsKey("items") ?
                response["items"]
                : response;
