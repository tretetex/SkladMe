...
{
    public partial class RequestParameters : Dictionary<string, string>
    {
        public RequestParameters()
        {
        }

        public RequestParameters(IDictionary<string, string> parameters) : base(parameters)
        {
        }
        ...
        /// </summary>
        public static RequestParameters Empty => new RequestParameters();
